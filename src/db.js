...
const sequelize = new Sequelize(`postgresql://postgres:${DB_PASSWORD}@containers-us-west-35.railway.app:5888/railway`, {
...
Complejo.belongsToMany(ServicesComplejo, {
  through: "complejoServices",
  foreignKey: "complejoId",
});
ServicesComplejo.belongsToMany(Complejo, {
  through: "complejoServices",
  foreignKey: " servicesComplejoId",
});
